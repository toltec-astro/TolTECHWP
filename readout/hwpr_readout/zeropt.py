...
class ZeroPointProducerThread(threading.Thread):
    ...
    def __init__(self, board, config, queue, shutdown_queue, debug=False, **kwargs):
        self.debug = debug
...
if __name__ == '__main__':
    ...
    test_ZeroPointThread = ZeroPointProducerThread(test_S826Board, config, queue.Queue(maxsize=-1), queue.Queue(maxsize=-1), debug=True)
